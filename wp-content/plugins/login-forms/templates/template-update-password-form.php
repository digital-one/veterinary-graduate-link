<?php
  ...
  */
  ...
  ?>
<!-- password reset form -->
  <div id="update-password-form" class="gform_wrapper notification">
...
<?php endif ?>
  ...
  <ul>
    <li class="no-label"><label class='gfield_label' for="user_pwd">Password<span class='gfield_required'>*</span></label>
<div class='ginput_container'><input name='user_pwd' id='user_pwd' type='password' placeholder='Password' value='' class='medium'    /></div>
</li>
<li class="no-label"><label class='gfield_label' for="user_pwd_confirm">Confirm Password<span class='gfield_required'>*</span></label>
<div class='ginput_container'><input name='user_pwd_confirm' id='user_pwd_confirm' type='password' placeholder='Confirm Password' value='' class='medium'    /></div>
 ...
 <a class="icon-button cancel">Cancel</a>  <button type="submit" class="icon-button tick"<?php if($login->_use_ajax):?>onclick="ajax_login(this.form);return false;"<?php endif ?>>Update Password</button>
