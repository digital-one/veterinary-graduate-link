...
<li><div class="link"><figure class="icon-box search"><div class="icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-search-candidates.svg" onerror="this.onerror=null; this.src='<?php echo get_template_directory_uri(); ?>/images/icon-search-candidates.png'" /></div></figure><h3>Search Candidates</h3><p>Tationi sit ut.Magna idque pro te, ius platonem consequat ex. Dicant delenit eleifend an mei, wisi disputationi sit ut.Persius volumus principes sed ea, sed erant omnes ex. Sed ex harum ancillae indoctum, sonet legere accommodare te mel.</p><footer><a href="" class="icon-button click">Click Here</a></footer></div<</li>
<li><div class="link"><figure class="icon-box blog"><div class="icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-blogs-advice.svg" onerror="this.onerror=null; this.src='<?php echo get_template_directory_uri(); ?>/images/icon-blogs-advice.png'" /></div></figure><h3>Blogs &amp; Advice</h3><p>Tationi sit ut.Magna idque pro te, ius platonem consequat ex. Dicant delenit eleifend an mei, wisi disputationi sit ut.Persius volumus principes sed ea, sed erant omnes ex. Sed ex harum ancillae indoctum, sonet legere accommodare te mel.</p><footer><a href="" class="icon-button click">Click Here</a></footer></div></li>
<?php if($vgl_user->is_logged_in()): ?>
<li><div class="link"><figure class="icon-box profile"><div class="icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-profile.svg" onerror="this.onerror=null; this.src='<?php echo get_template_directory_uri(); ?>/images/icon-profile.png'" /></div></figure><h3>Edit Profile</h3><p>Tationi sit ut.Magna idque pro te, ius platonem consequat ex. Dicant delenit eleifend an mei, wisi disputationi sit ut.Persius volumus principes sed ea, sed erant omnes ex. Sed ex harum ancillae indoctum, sonet legere accommodare te mel.</p><footer><a href="<?php echo $vgl_user->get_profile_url() ?>" class="icon-button click">Click Here</a></footer></div></li>
<?php else: ?>
<li><div class="link"><figure class="icon-box profile"><div class="icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-profile.svg" onerror="this.onerror=null; this.src='<?php echo get_template_directory_uri(); ?>/images/icon-profile.png'" /></div></figure><h3>Register</h3><p>Tationi sit ut.Magna idque pro te, ius platonem consequat ex. Dicant delenit eleifend an mei, wisi disputationi sit ut.Persius volumus principes sed ea, sed erant omnes ex. Sed ex harum ancillae indoctum, sonet legere accommodare te mel.</p><footer><a rel="role-selection" class="notification-btn icon-button click" class="icon-button click">Click Here</a></footer></div></li>

<?php endif ?>
<li><div class="link"><figure class="icon-box contact"><div class="icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-contact.svg" onerror="this.onerror=null; this.src='<?php echo get_template_directory_uri(); ?>/images/icon-contact.png'" /></div></figure><h3>Contact Us</h3><p>Tationi sit ut.Magna idque pro te, ius platonem consequat ex. Dicant delenit eleifend an mei, wisi disputationi sit ut.Persius volumus principes sed ea, sed erant omnes ex. Sed ex harum ancillae indoctum, sonet legere accommodare te mel.</p><footer><a href="" class="icon-button click">Click Here</a></footer></div></li>
</ul>
</div>
</div>
</section>
