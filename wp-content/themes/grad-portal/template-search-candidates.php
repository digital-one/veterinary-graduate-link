...
<li class="small-12 medium-6 large-4 columns gfield end">
...
<div class="small-12 columns"><button type="submit" class="icon-button search">Search</button><a href="" class="icon-button shortlist">My Shortlist</a></div>
</div>
</form>
</section>
<!--/search form-->
...
<footer><a href="" class="icon-button profile">Show Profile</a><a href="" class="icon-button plus">Shortlist Me</a></footer>
	</li>
...
<footer><a href="" class="more-posts"><i class="fa fa-cog fa-spin"></i> Loading more results</a></footer>
</section>
